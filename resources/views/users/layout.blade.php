...
<html lang="en">
  <head>
    ...
    <title>Requisition Management System - GGAST</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="/all_requests"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Requests</span></a></li>
